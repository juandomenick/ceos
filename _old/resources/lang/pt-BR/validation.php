...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'curso_id'                          => 'curso',
        'coordenador.celular'               => 'celular',
        'coordenador.email'                 => 'email',
        'coordenador.nome'                  => 'nome',
        'coordenador.password'              => 'senha',
        'coordenador.password_confirmation' => 'confirmação da senha',
        'coordenador.usuario'               => 'usuário',
        'diretor.celular'                   => 'celular',
        'diretor.email'                     => 'email',
        'diretor_id'                        => 'diretor',
        'diretor.nome'                      => 'nome',
        'diretor.password'                  => 'senha',
        'diretor.password_confirmation'     => 'confirmação da senha',
        'diretor.usuario'                   => 'usuário',
        'email'                             => 'e-mail',
        'excerpt'                           => 'resumo',
