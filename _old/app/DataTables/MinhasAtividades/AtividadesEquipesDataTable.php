...
/**
 * Class AtividadesEquipesDataTable
 *
 * @package App\DataTables\MinhasAtividades
 */
class AtividadesEquipesDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('equipe', function (AtividadeDesignavel $atividade) {
            ...
            ->addColumn('action', 'dashboard.minhas-atividades.equipes.datatables.actions');
    }
    ...
    {
        return $model->newQuery()->where('atividade_designavel_type', Equipe::class);
    }
    ...
    {
        return 'atividades-equipes_' . date('YmdHis');
    }
}
